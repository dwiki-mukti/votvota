              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td style="display: flex; justify-content: space-between; padding-top: 5px; padding-bottom: 0;">
                    ...
                    <!-- end modal -->
                    <a href="/kandidat/{{$k->id}}" class="text-warning text-center p-fs12"><i class="fas fa-edit"></i><p>edit</p></a>
                    <form method="post" action="kandidat">
                      {{ csrf_field() }}
                      <input type="hidden" name="_method" value="DELETE">
                      <input type="hidden" name="id" value="{{$k->id}}">
                      <button class="text-danger text-center p-fs12" onclick="return confirm('Apakah anda ingin menghapus data ini?');"><i class="fas fa-trash"></i><p>delete</p></button>
                    </form>
                  </td>
                  <?php $i++; ?>
                </tr>
